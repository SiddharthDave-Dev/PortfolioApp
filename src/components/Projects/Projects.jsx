...
const Projects = () => {
  ...
  const containerVariants = { hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.05, duration: 0.4 } } };
  const itemVariants = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 120, damping: 15, duration: 0.4 } } };
  const cardVariants = { hidden: { opacity: 0, scale: 0.9 }, visible: { opacity: 1, scale: 1, transition: { type: "spring", stiffness: 150, damping: 20, duration: 0.4 } } };
  ...
  const openProject = (project) => {
    ...
    document.body.style.overflow = 'hidden';
    const header = document.querySelector('header') || document.querySelector('.navbar') || document.querySelector('.header');
    if (header) { header.style.transform = 'translateY(-100%)'; header.style.transition = 'transform 0.3s ease-in-out'; }
  };
  ...
  const closeModal = () => {
    ...
    document.body.style.overflow = 'unset';
    const header = document.querySelector('header') || document.querySelector('.navbar') || document.querySelector('.header');
    if (header) { header.style.transform = 'translateY(0)'; header.style.transition = 'transform 0.3s ease-in-out'; }
  };
  ...
  // ... (Modal/gallery logic same as your original code)
  ...
  return (
    ...
    >
      <div className="projects-container">
        {/* Projects Header */}
        <motion.div className="projects-header" variants={itemVariants}>
          <motion.h2 className="projects-title">{portfolioContent.projects?.title || "My Projects"}</motion.h2>
