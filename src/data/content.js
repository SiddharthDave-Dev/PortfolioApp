        ...
        tools: [
            {
                ...
                items: ["Xcode", "VS Code", "Git", "GitHub", "SoureTree", "Terminal", "Postman", "Anaconda", "Figma"]
            },
            {
                category: "Languages",
                items: ["Swift", "Python", "SQL", "HTML", "CSS", "SwiftUI"]
            },
            {
                category: "Frameworks",
                items: ["SwiftUI", "UIKit", "React", "TensorFlow", "Core Data", "Firebase", "Node.js", "Realm"]
            },
            {
                category: "Cloud & Services",
                items: ["Firebase", "MongoDB", "App Store Connect", "TestFlight", "Analytics", "Realm"]
            }
        ],
